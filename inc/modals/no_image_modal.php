...
?>
<div class="remodal iqx-amplify-remodal no-image" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
  ...
  <div>
    <div class="iqx-amplify-optin-image-wrapper">
      <img class="iqx-amplify-optin-image-no-image" src="">
    </div>
    <h2 class="iqx-amplify-no-image-modal-thanks-title"><?php _e($popupSubHeadline); ?></h2>
    <h2 class="iqx-amplify-no-image-modal-title iqx-amplify-discount-title"><?php _e($popupHeadline); ?></h2>
    <h2 class="iqx-amplify-no-image-modal-title hide iqx-amplify-subscribed-title">You are now subscribed!</h2>

    <div class="iqx-amplify-optin-wrapper">


      <h2 class="iqx-amplify-modal-success-message no-image hide">You will receive a text message momentarily confirming your subscription.</h2>
      <div class="iqx-amplify-phone-input-no-image-wrapper">
      ...
      <div class="iqx-amplify-modal-spinner-no-image-wrapper hide">
        <i class="fa fa-spinner fa-spin" aria-hidden="true"></i>
      </div>
    </div>
  </div>
  <br>
  <div class="iqx-amplify-no-image-modal-footer">
